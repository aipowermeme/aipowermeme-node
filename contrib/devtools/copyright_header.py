...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The AIPowerMeme Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a AIPowerMeme Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The AIPowerMeme Core developers'
...
Arguments:
    <base_directory> - The base directory of AIPowerMeme Core source code repository.
"""
...
Arguments:
    <file> - A source file in the AIPowerMeme Core repository.
"""
