# Bootstrappable AIPowerMeme Core Builds

This directory contains the files necessary to perform bootstrappable AIPowerMeme
Core builds.
...
To build AIPowerMeme Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      AIPowerMeme Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/aipowermeme-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/aipowermemepay/guix.sigs).
...
[guix-docker]: https://github.com/aipowermeme/tree/master/contrib/guix/Dockerfile
