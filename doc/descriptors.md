# Support for Output Descriptors in AIPowerMeme Core

Since AIPowerMeme Core v0.17, there is support for Output Descriptors. This is a
...
existing AIPowerMeme Core wallets, a convenience function `combo` is
...
All RPCs in AIPowerMeme Core will include the checksum in their output. Only
