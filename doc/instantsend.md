...
This mechanism has been integrated into Bitcore-Node-AIPowerMeme which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/aipowermemepay/insight-api-aipowermeme#web-socket-api](https://github.com/aipowermemepay/insight-api-aipowermeme#web-socket-api)
* API: [https://github.com/aipowermemepay/insight-api-aipowermeme#instantsend-transactions](https://github.com/aipowermemepay/insight-api-aipowermeme#instantsend-transactions)
