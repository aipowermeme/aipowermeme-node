...
This document provides guidelines for internationalization of the AIPowerMeme Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `aipowermeme_en.ts` remains unchanged.
