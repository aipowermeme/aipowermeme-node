...
//! Interface for the src/evo part of a aipowermeme node (aipowermemed process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a aipowermeme node (aipowermemed process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a aipowermeme node (aipowermemed process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a aipowermeme node (aipowermemed process).
...
//! Top-level interface for a aipowermeme node (aipowermemed process).
class Node
{
public:
    virtual ~Node() {}
