 ...
 *  We have 4 times smaller block times in AIPowerMeme, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        AIPowerMeme Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // APME this code also handles non-TXs (AIPowerMeme specific messages)
