...
/** Utility functions used by the AIPowerMeme Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "aipowermeme:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load aipowermeme specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a aipowermeme specific theme is activated (light/dark).*/
