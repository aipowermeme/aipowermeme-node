...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 APME irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on aipowermemecentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "aipowermeme",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "aipowermeme",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "aipowermeme",               "gobject",                &gobject,                {} },
    { "aipowermeme",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
