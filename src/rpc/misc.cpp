...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"aipowermeme\" activates all AIPowerMeme-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "aipowermeme")
    + HelpExampleRpc("debug", "aipowermeme+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The aipowermeme address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The aipowermeme address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of APOMEME"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of APOMEME of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in APOMEME"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in APOMEME"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in APOMEME"},
                    {RPCResult::Type::NUM, "received", "The total number of APOMEME received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "aipowermeme-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* AIPowerMeme features */
    { "aipowermeme",               "mnsync",                 &mnsync,                 {} },
    { "aipowermeme",               "spork",                  &spork,                  {"command"} },
    { "aipowermeme",               "sporkupdate",            &sporkupdate,            {"name","value"} },
