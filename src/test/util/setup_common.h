...
/* Initialize AIPowerMeme-specific components after chainstate initialization */
void AIPowerMemeTestSetup(NodeContext& node);
void AIPowerMemeTestSetupClose(NodeContext& node);
