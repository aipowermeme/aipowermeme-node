...
"""Verify that starting aipowermemed with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aipowermemed with -h for help text")
        ...
        self.log.info("Start aipowermemed with -version for version information")
        ...
        self.log.info("Start aipowermemedd with -fakearg to make sure it does not start")
