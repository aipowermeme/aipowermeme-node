...
By default, aipowermemed will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent aipowermemed from writing mempool.dat to disk. Verify that `savemempool` fails")
