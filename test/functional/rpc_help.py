...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: AIPowerMeme's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'AIPowerMeme', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
